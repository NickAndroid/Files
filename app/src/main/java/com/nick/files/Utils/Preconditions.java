...
public class Preconditions {
    ...
    /**
     * Ensures that the {@link java.util.Collection} is not {@code null}, and none of its elements are
     * {@code null}.
     *
     * @param value     a {@link java.util.Collection} of boxed objects
     * @param valueName the name of the argument to use if the check fails
     * @return the validated {@link java.util.Collection}
     * @throws NullPointerException if the {@code value} or any of its elements were {@code null}
     */
